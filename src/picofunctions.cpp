...
{
    cout << "Showing parameter : " << param << endl;
    if (node == nullptr)
    {
        cout << "ERROR no such parameter : " << param << endl;
        return false;
    }
    if (strlen(node.text().get()) == 0)
    {
        cout << "ERROR no text for parameter : " << param << endl;
        return false;
    }
    cout << param << " get text: " << node.text().get() << endl;
    cout << param << " get as int : " << check(node.text().get()) << endl;
    return true;
}
...
string return_fun(uint32_t value)
{
    ...
    case PICO_RATIO_MODE_NOT_SUPPORTED:
        rv = "PICO_RATIO_MODE_NOT_SUPPORTED";
        break;
    case PICO_NO_SAMPLES_AVAILABLE:
        rv = "PICO_NO_SAMPLES_AVAILABLE";
        break;
    case PICO_DEVICE_SAMPLING:
        rv = "PICO_DEVICE_SAMPLING";
        break;
    case PICO_NULL_PARAMETER:
        rv = "PICO_NULL_PARAMETER";
        break;
    case PICO_DATA_NOT_AVAILABLE:
        rv = "PICO_DATA_NOT_AVAILABLE";
        break;
    case PICO_STARTINDEX_INVALID:
        rv = "PICO_STARTINDEX_INVALID";
        break;
    case PICO_INVALID_SAMPLERATIO:
        rv = "PICO_INVALID_SAMPLERATIO";
        break;
    case PICO_INVALID_CALL:
        rv = "PICO_INVALID_CALL";
        break;
    case PICO_BUFFERS_NOT_SET:
        rv = "PICO_BUFFERS_NOT_SET";
        break;
    case PICO_ETS_NOT_RUNNING:
        rv = "PICO_ETS_NOT_RUNNING";
        break;
    case PICO_TOO_MANY_CHANNELS_IN_USE:
        rv = "PICO_TOO_MANY_CHANNELS_IN_USE";
        break;
    case PICO_INVALID_CONDITION_INFO:
        rv = "PICO_INVALID_CONDITION_INFO";
        break;
    case PICO_DUPLICATE_CONDITION_SOURCE:
        rv = "PICO_DUPLICATE_CONDITION_SOURCE";
        break;
    case PICO_CANCELLED:
        rv = "PICO_CANCELLED";
        break;
...
uint32_t timebase_choice(const int32_t SAMPLE_FREQ)
{
